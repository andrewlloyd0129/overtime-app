...
describe 'navigate' do
  ...
  describe 'index' do
    ...
    it 'has a scope so that only post creaters can see thier posts' do
      post1 = FactoryGirl.build_stubbed(:post)
      post2 = FactoryGirl.build_stubbed(:second_post)
  ...
  describe 'delete' do
    it 'can be deleted' do
      ...
      post_to_delete = Post.create(date: Date.today, rationale: "Rationale", user_id: delete_user.id, overtime_request: 1.5)
